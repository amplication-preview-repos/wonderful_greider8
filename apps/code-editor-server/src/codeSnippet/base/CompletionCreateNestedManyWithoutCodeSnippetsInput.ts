...
@InputType()
class CompletionCreateNestedManyWithoutCodeSnippetsInput {
...
export { CompletionCreateNestedManyWithoutCodeSnippetsInput as CompletionCreateNestedManyWithoutCodeSnippetsInput };
